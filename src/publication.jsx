    ...
    <div className="container">
      <div className="publication-header">
        <div className="publication-title-row">
          ...
          <button
            type="button"
            className="publication-inline-toggle"
            onClick={() => setIsExpanded((prev) => !prev)}
            aria-expanded={isExpanded}
            aria-controls="all-publications-list"
            aria-label={isExpanded ? "Hide publications" : "Show publications"}
          >
            &gt;&gt;
          </button>
        </div>
      ...
      {isExpanded && (
        <div id="all-publications-list" className="list-container">
          {data.map((item) => (
